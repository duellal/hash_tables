...
During the for loop for making the cipher, the 'X' or the 'J' would get overwritten. I tried working the code and thinking of how not to have this happen, but I could not think of a way to do it. 

I then implemented the ASCII code to get the cipher to fully work.
*/
